...
#define __PYX_HAVE__qiskit__providers__aer__pulse__cy__channel_value
#define __PYX_HAVE_API__qiskit__providers__aer__pulse__cy__channel_value
/* Early includes */
#include <math.h>
#include <complex>
#include "pythread.h"
...
/* Module declarations from 'qiskit.providers.aer.pulse.cy.channel_value' */
...
static CYTHON_INLINE int __pyx_f_6qiskit_9providers_3aer_5pulse_2cy_13channel_value_get_arr_idx(double, double, double, int); /*proto*/
...
#define __Pyx_MODULE_NAME "qiskit.providers.aer.pulse.cy.channel_value"
extern int __pyx_module_is_main_qiskit__providers__aer__pulse__cy__channel_value;
int __pyx_module_is_main_qiskit__providers__aer__pulse__cy__channel_value = 0;

/* Implementation of 'qiskit.providers.aer.pulse.cy.channel_value' */
...
/* "qiskit/providers/aer/pulse/cy/channel_value.pyx":28
 * 
...
static CYTHON_INLINE int __pyx_f_6qiskit_9providers_3aer_5pulse_2cy_13channel_value_get_arr_idx(double __pyx_v_t, double __pyx_v_start, double __pyx_v_stop, int __pyx_v_len_arr) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_arr_idx", 0);

  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":40
...
/* "qiskit/providers/aer/pulse/cy/channel_value.pyx":43
 * 
 * @cython.boundscheck(False)
...
static __pyx_t_double_complex __pyx_f_6qiskit_9providers_3aer_5pulse_2cy_13channel_value_chan_value(double __pyx_v_t, CYTHON_UNUSED unsigned int __pyx_v_chan_num, double __pyx_v_freq_ch, __Pyx_memviewslice __pyx_v_chan_pulse_times, __Pyx_memviewslice __pyx_v_pulse_array, __Pyx_memviewslice __pyx_v_pulse_ints, __Pyx_memviewslice __pyx_v_fc_array, __Pyx_memviewslice __pyx_v_register) {
  size_t __pyx_v_kk;
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":68
 *     """
 *     cdef size_t kk
 ...
 */
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":70
 *     cdef double start_time, stop_time, phase=0
 *     cdef int start_idx, stop_idx, offset_idx, temp_int, cond
 *     cdef complex out = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":73
 *     # This is because each entry has four values:
 *     # start_time, stop_time, pulse_int, conditional
 ...
 */
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":75
 *     cdef unsigned int num_times = chan_pulse_times.shape[0] // 4
 * 
 *     for kk in range(num_times):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":77
 *     for kk in range(num_times):
 *         # the time is overlapped with the kkth pulse
 *         start_time = chan_pulse_times[4*kk]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":78
 *         # the time is overlapped with the kkth pulse
 *         start_time = chan_pulse_times[4*kk]
 *         stop_time = chan_pulse_times[4*kk+1]             # <<<<<<<<<<<<<<
 *         if start_time <= t < stop_time:
 ...
 */
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":79
 *         start_time = chan_pulse_times[4*kk]
 *         stop_time = chan_pulse_times[4*kk+1]
 *         if start_time <= t < stop_time:             # <<<<<<<<<<<<<<
 *             cond = <int>chan_pulse_times[4*kk+3]
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":80
 *         stop_time = chan_pulse_times[4*kk+1]
 *         if start_time <= t < stop_time:
 *             cond = <int>chan_pulse_times[4*kk+3]             # <<<<<<<<<<<<<<
 *             if cond < 0 or register[cond]:
 ...
 */
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":81
 *         if start_time <= t < stop_time:
 *             cond = <int>chan_pulse_times[4*kk+3]
 *             if cond < 0 or register[cond]:             # <<<<<<<<<<<<<<
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":82
 *             cond = <int>chan_pulse_times[4*kk+3]
 *             if cond < 0 or register[cond]:
 *                 temp_int = <int>chan_pulse_times[4*kk+2]             # <<<<<<<<<<<<<<
 *                 start_idx = pulse_ints[temp_int]
 ...
 */
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":83
 *             if cond < 0 or register[cond]:
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 *                 start_idx = pulse_ints[temp_int]             # <<<<<<<<<<<<<<
 *                 stop_idx = pulse_ints[temp_int+1]
 ...
 */
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":84
 *                 temp_int = <int>chan_pulse_times[4*kk+2]
 *                 start_idx = pulse_ints[temp_int]
 *                 stop_idx = pulse_ints[temp_int+1]             # <<<<<<<<<<<<<<
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 ...
 */
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":85
 *                 start_idx = pulse_ints[temp_int]
 *                 stop_idx = pulse_ints[temp_int+1]
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)             # <<<<<<<<<<<<<<
 *                 out = pulse_array[start_idx+offset_idx]
 *             break
 */
        __pyx_v_offset_idx = __pyx_f_6qiskit_9providers_3aer_5pulse_2cy_13channel_value_get_arr_idx(__pyx_v_t, __pyx_v_start_time, __pyx_v_stop_time, (__pyx_v_stop_idx - __pyx_v_start_idx));

        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":86
 *                 stop_idx = pulse_ints[temp_int+1]
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 *                 out = pulse_array[start_idx+offset_idx]             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":87
 *                 offset_idx = get_arr_idx(t, start_time, stop_time, stop_idx-start_idx)
 *                 out = pulse_array[start_idx+offset_idx]
 *             break             # <<<<<<<<<<<<<<
 *     # Compute the frame change up to time t
 ...
 */
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":89
 *             break
 *     # Compute the frame change up to time t
 *     if out != 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":90
 *     # Compute the frame change up to time t
 *     if out != 0:
 *         num_times = fc_array.shape[0] // 3             # <<<<<<<<<<<<<<
 *         for kk in range(num_times):
 ...
 */
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":91
 *     if out != 0:
 *         num_times = fc_array.shape[0] // 3
 *         for kk in range(num_times):             # <<<<<<<<<<<<<<
 *             if t >= fc_array[3*kk]:
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":92
 *         num_times = fc_array.shape[0] // 3
 *         for kk in range(num_times):
 *             if t >= fc_array[3*kk]:             # <<<<<<<<<<<<<<
 *                 do_fc = 1
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":93
 *         for kk in range(num_times):
 *             if t >= fc_array[3*kk]:
 *                 do_fc = 1             # <<<<<<<<<<<<<<
 *                 # Check if FC is conditioned on register
 ...
 */
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":95
 *                 do_fc = 1
 *                 # Check if FC is conditioned on register
 *                 if fc_array[3*kk+2] >= 0:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":97
 *                 if fc_array[3*kk+2] >= 0:
 *                     # If condition not satisfied no do FC
 *                     if not register[<int>fc_array[3*kk+2]]:             # <<<<<<<<<<<<<<
 *                         do_fc = 0
 ...
 */
          ...
          if (__pyx_t_7) {
            ...
            /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":98
 *                     # If condition not satisfied no do FC
 *                     if not register[<int>fc_array[3*kk+2]]:
 *                         do_fc = 0             # <<<<<<<<<<<<<<
 *                 if do_fc:
 ...
 */
        ...
        /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":99
 *                     if not register[<int>fc_array[3*kk+2]]:
 *                         do_fc = 0
 *                 if do_fc:             # <<<<<<<<<<<<<<
 *                     # Update the frame change value
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":101
 *                 if do_fc:
 *                     # Update the frame change value
 *                     phase += fc_array[3*kk+1]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":103
 *                     phase += fc_array[3*kk+1]
 *             else:
 *                 break             # <<<<<<<<<<<<<<
 *         if phase != 0:
 ...
 */
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":104
 *             else:
 *                 break
 *         if phase != 0:             # <<<<<<<<<<<<<<
 *             out *= exp(1j*phase)
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":105
 *                 break
 *         if phase != 0:
 *             out *= exp(1j*phase)             # <<<<<<<<<<<<<<
 *         out *= exp(-1j*2*M_PI*freq_ch*t)
 ...
 */
    ...
    /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":106
 *         if phase != 0:
 *             out *= exp(1j*phase)
 *         out *= exp(-1j*2*M_PI*freq_ch*t)             # <<<<<<<<<<<<<<
 *     return out
 ...
 */
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":107
 *             out *= exp(1j*phase)
 *         out *= exp(-1j*2*M_PI*freq_ch*t)
 *     return out             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "qiskit.providers.aer.pulse.cy.channel_value.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.pulse.cy.channel_value.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.pulse.cy.channel_value.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "qiskit.providers.aer.pulse.cy.channel_value._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("chan_value", (void (*)(void))__pyx_f_6qiskit_9providers_3aer_5pulse_2cy_13channel_value_chan_value, "__pyx_t_double_complex (double, unsigned int, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_qiskit__providers__aer__pulse__cy__channel_value) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qiskit.providers.aer.pulse.cy.channel_value")) {
      if (unlikely(PyDict_SetItemString(modules, "qiskit.providers.aer.pulse.cy.channel_value", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "qiskit/providers/aer/pulse/cy/channel_value.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * #!python
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qiskit.providers.aer.pulse.cy.channel_value", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qiskit.providers.aer.pulse.cy.channel_value");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
